...
protocol UsersViewModelType {
    ...
    var userFoundDefault: String { get }
}
...
extension UsersViewModel : UsersViewModelType {
	...
	var shouldShowUsersSearchView: Bool {
		return false
	}
	
	var usersCountInfo: String {
		return ""
	}
...
//    private var usersFetched: [UserModel]
//
